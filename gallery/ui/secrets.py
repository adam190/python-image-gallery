...
def get_secret_image_gallery():
    ...
    try:
        ...
        if e.response['Error']['Code'] == 'DecryptionFailureException':
            ...
            # An error occurred on the server side. Deal with the exception here, 
            ...
            # state of the resource. Deal with the exception here, and/or rethrow 
            # at your discretion.
            raise e 
        ...
        # Decrypts secret using the associated KMS CMK. Depending on whether the 
        # secret is a string or binary, one of these fields will be populated.
